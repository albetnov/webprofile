        ...
        <div class="page-heading">
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        ...
                        <p class="text-subtitle text-muted">Fill the form to Add Service Page!</p>
                    </div>
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">Manage Page</li>
                                <li class="breadcrumb-item active" aria-current="page">Add Service Page</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <section class="section">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('addsvc') }}" enctype="multipart/form-data" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="service_desc"
                                    ...
                                    placeholder="Service Descriptions..." value="{{ old('service_desc') }}">
                                @error('service_desc')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
